...
import { noUsedUnderscoreParam } from "./no-used-underscore-param.ts";
...
const invalid = [
  ...
  {
    code: "function outer(_x) { function inner(_x) { return _x; } return _x; }",
    errors: 2,
  },
];

test({ valid, invalid, ...noUsedUnderscoreParam });
