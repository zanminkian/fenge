...
{"engines":{"node":"^20.18.0"}} // filename: /foo/package.json
{"engines":{"node":"^20.18.999"}} // filename: /foo/package.json
```
...
{"engines":{"node":"^20.19.0"}} // filename: /foo/package.json
{"engines":{"node":"^20.19.999"}} // filename: /foo/package.json
```
<!-- prettier-ignore-end -->
